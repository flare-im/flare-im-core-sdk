...
pub struct MemoryExtensionProvider {
    ...
    session_extensions:
        Arc<tokio::sync::RwLock<std::collections::HashMap<String, SessionExtension>>>,
}
...
pub struct MemoryExtensionCache {
    ...
    session_cache:
        Arc<tokio::sync::RwLock<std::collections::HashMap<String, (SessionExtension, i64)>>>,
    ttl_seconds: i64,
}
...
mod tests {
    ...
    async fn test_memory_extension_provider() {
        ...
        provider
            .set_user_extension("user_123".to_string(), user_ext.clone())
            .await;
    ...
    async fn test_memory_extension_cache() {
        ...
        cache
            .save_user_extension("user_123", &user_ext)
            .await
            .unwrap();
