...
use crate::infrastructure::task::standard::{TaskExecutionMode, TaskResult, TaskType};
use anyhow::Result;
...
///
/// ```rust,no_run
/// use crate::infrastructure::task::executor::{SyncTaskExecutor, SyncContext};
/// use crate::infrastructure::task::standard::{priority, TaskResult};
/// use async_trait::async_trait;
///
/// struct MySyncTask;
///
...
pub trait SyncTaskExecutor: Send + Sync {
    ...
    fn priority(&self) -> u32 {
        crate::infrastructure::task::standard::priority::DEFAULT
    }
