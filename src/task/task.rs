...
use crate::task::standard::{TaskResult, TaskStatus};
use anyhow::Result;
use std::sync::Arc;
...
impl SyncTask {
    ...
    pub fn is_mandatory(&self) -> bool {
        matches!(self.executor.task_type(), crate::task::standard::TaskType::Mandatory)
    }
    ...
    /// 获取执行模式
    pub fn execution_mode(&self) -> crate::task::standard::TaskExecutionMode {
